...
while($gal = mysql_fetch_array($galeria)){
	...
	if($numimg==0){
		...
		$img_grande='dibujar.php?file=admin/archivos/'.$gal['aga_imagen'].'&ancho=360&alto=330&cut=1';

	}

	$arrgaleria[]= 'admin/archivos/'.$gal['aga_imagen'];

	$jsgaleria.= 'case '.$numimg.':document.getElementById(\'imagen_principal\').src="images/cargando.gif";document.getElementById(\'imagen_principal\').src="'.'dibujar.php?file=admin/archivos/'.$gal['aga_imagen'].'&ancho=363&alto=330&cut=1";break;';
  ...
  <div id="info">
    ...
    <div id="TabbedPanels1" class="TabbedPanels">
      ...
      <div class="TabbedPanelsContentGroup">
        ...
        <div class="TabbedPanelsContent">
		<?php //echo _('Precio: ').$row['apa_precio'];?> 
