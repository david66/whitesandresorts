...
$url="http://www.whitesandresorts.es/";

$url_admin="http://www.whitesandresorts.es/admin/";



///PLANTILLA DEL MAIL

$empresa = "whitesandresorts";
...
$from="noreply@whitesandresorts.es";



//DESTINATARIOS DE CORREO

$dest_contacto = "info@wsresorts.es";



//EDITOR HTML, URL DE LAS IMAGENES

$_SESSION['ARCHIVOS']="http://www.whitesandresorts.es/admin/".$_SESSION['PATH_ARCHIVOS'];
